...
public class Robot2 extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        // robot properties have all the properties initialized for the robot to work appropriately.
    ...
    public void autonomousInit() {
        ...
        // defaultAuto);
        robotProperties.getTimer().reset();
        robotProperties.getTimer().start();
    }
    ...
    public void teleopPeriodic() {
        for(RobotController controller : controllers) {
            controller.performAction(robotProperties);
        }
    }
